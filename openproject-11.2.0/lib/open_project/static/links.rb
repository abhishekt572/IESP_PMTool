        ...
        def static_links
          {
            ...
            user_guides: {
              href: 'http://10.129.3.158:30000/user-guide/',
            ...
            glossary: {
              href: 'https://nokiaiesp-prod.ngrok.io/iesppmt/projects/iesp-pm-tool-development/roadmap',
              label: 'homescreen.links.glossary'
            },
            shortcuts: {
              href: 'http://10.129.3.158:30000/user-guide/keyboard-shortcuts-access-keys/',
              label: 'homescreen.links.shortcuts'
            },
            forums: {
              href: 'https://nokiaiesp-prod.ngrok.io/iesppmt/projects/iesp-pm-tool-development/forums',
              label: 'homescreen.links.forums'
            },
	    excel_download:{
		href:'https://nokia.sharepoint.com/:f:/r/sites/nokiaiesp/Shared%20Documents/ExternalDocuments/DigitalToolDocuments/IESP-PMT?csf=1&amp;web=1&amp;e=uwAQAR',
              	label: :label_excel_download
	    },
	    raise_documentation_issue:{
		href: 'https://nokiaiesp-prod.ngrok.io/iesppmt/projects/iesp-pm-tool-development/work_packages/new?type=11',
              	label: :label_raise_documentation_issue
	    },
	    request_feature:{
		href: 'https://nokiaiesp-prod.ngrok.io/iesppmt/projects/iesp-pm-tool-development/work_packages/new?type=4',
              	label: :label_request_feature
	    },
	    raise_bug:{
		href: 'https://nokiaiesp-prod.ngrok.io/iesppmt/projects/iesp-pm-tool-development/work_packages/new?type=7',
              	label: :label_raise_bug
	    },
