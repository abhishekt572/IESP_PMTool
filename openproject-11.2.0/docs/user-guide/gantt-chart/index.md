...
sidebar_navigation:
  title: Gantt charts
  priority: 865
description: Create project timelines with Gantt charts in IESP PM TOOL
robots: index, follow
...
| [Synchronize data between IESP PM TOOL and Excel](#synchronize-data-between-IESP PM TOOL-and-excel) | How to synchronize data from IESP PM TOOL to Excel?           |
...
*IESP PM TOOL does not yet include a baseline feature to compare scheduled versions. However, we are aware of the need for it and documented it. Please check here https://community.openproject.com/projects/openproject/work_packages/26448/activity for an update.*
...
* [Synchronize data from IESP PM TOOL to Excel](#synchronize-data-between-IESP PM TOOL-and-Excel) <-> MS Project
...
## Synchronize data between IESP PM TOOL and Excel

You can synchronize your work package data between IESP PM TOOL and Excel (two-way synchronization). By extension you could import MS Project files - by saving them as Excel files and importing them into IESP PM TOOL. You can download a free Excel synchronization template to do this.

Follow our [Step by step guide how to synchronize your Excel Sheet with IESP PM TOOL](../integrations/Excel Synchronization).
