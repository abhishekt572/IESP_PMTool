...
### Is it possible that we can have a board over all IESP PM TOOL tasks and users? 
...
### What is the best way to maintain an overview of multiple projects in IESP PM TOOL? Is it possible to create a dashboard that shows all the projects you are responsible for at once?
