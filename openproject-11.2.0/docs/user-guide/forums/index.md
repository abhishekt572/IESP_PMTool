...
sidebar_navigation:
  title: Forums
  priority: 820
description: Create and manage a forum in IESP PM TOOL
robots: index, follow
...
In the forum in IESP PM TOOL you can discuss topics in a project with the team: post questions, comment on it and document answers.
...
To work in the forum in IESP PM TOOL, select the menu item **Forums** in the project navigation.
