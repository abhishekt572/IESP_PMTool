...
sidebar_navigation:
  title: Work packages
  priority: 870
description: Find out about work packages in IESP PM TOOL
robots: index, follow
...
| [Create a work package](create-work-package)                 | How to create a new work package in IESP PM TOOL?             |
| [Edit work package](edit-work-package)                       | How to edit a work package in IESP PM TOOL?                   |
...
### We like for each department to have their own custom "status" with different value options in IESP PM TOOL. How do we do this?
